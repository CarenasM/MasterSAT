...
# --- CARGA DE DATOS (MAPEO POR POSICIÓN) ---
@st.cache_data
def load_all_data(lang):
    # Caudales: serie(0), dim(1), mod(2), año(3), consig(4), bypass(5), lower(6), xtras(7)
